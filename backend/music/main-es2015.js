...
/* harmony import */ var _calendar_calendar_resolver__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./calendar/calendar.resolver */ "./src/app/calendar/calendar.resolver.ts");
...
const routes = [
    ...
    { path: 'calendar',
        ...
        resolve: { calendar: _calendar_calendar_resolver__WEBPACK_IMPORTED_MODULE_6__["CalendarResolverService"] } }
];
...
/* harmony import */ var _store_actions_posts_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./store/actions/posts.actions */ "./src/app/store/actions/posts.actions.ts");
...
/* harmony import */ var _list_posts_list_posts_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./list-posts/list-posts.component */ "./src/app/list-posts/list-posts.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _list_posts_list_posts_component__WEBPACK_IMPORTED_MODULE_19__["ListPostsComponent"]
        ],
        imports: [
...
/* harmony import */ var _store_reducers_posts_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/reducers/posts.reducer */ "./src/app/store/reducers/posts.reducer.ts");
...
let CalendarComponent = class CalendarComponent {
    constructor(store, activatedRoute, dialog) {
        this.store = store;
        this.activatedRoute = activatedRoute;
        this.dialog = dialog;
        this.releaseDates = [];
        this.isLoadingSub = this.store.select(_store_reducers_posts_reducer__WEBPACK_IMPORTED_MODULE_4__["isLoadingpost"]).subscribe(val => this.isLoading = val);
    }
    ngOnInit() {
    ...
    onSelect(event) {
        ...
        if (hasReleases && postsOnDate.length > 0) {
            ...
            this.dialog.open(_list_posts_list_posts_component__WEBPACK_IMPORTED_MODULE_6__["ListPostsComponent"], { data: postsOnDate });
        }
    }
    getClass() {
        return (date) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CalendarResolverService", function() { return CalendarResolverService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let CalendarResolverService = class CalendarResolverService {
    ...
    resolve(route, state) {
        return this.endpoint.getPosts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])((error) => {
            return rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"];
        }));
    }
};
CalendarResolverService.ctorParameters = () => [
    { type: _endpoint_endpoint_service__WEBPACK_IMPORTED_MODULE_4__["EndpointService"] },
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_5__["Store"] }
];
CalendarResolverService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let EndpointService = class EndpointService {
    ...
    updateOrderPost(posts) {
        return this.http.put(BACKEND_URL + '/posts/update', { posts });
    }
};
...
let ListPostsComponent = class ListPostsComponent {
    ...
    deletePost(id) {
        console.log('id ', id);
        if (id) {
            this.store.dispatch(Object(_store_actions_posts_actions__WEBPACK_IMPORTED_MODULE_5__["deletePostRequest"])({ id }));
            this.dialog.closeAll();
        }
    }
    saveOrder() {
        console.log('save order ', this.data);
        this.store.dispatch(Object(_store_actions_posts_actions__WEBPACK_IMPORTED_MODULE_5__["updateOrderRequest"])({ posts: this.data }));
    }
};
...
ListPostsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list-posts.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/list-posts/list-posts.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list-posts.component.scss */ "./src/app/list-posts/list-posts.component.scss")).default]
    }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateOrderRequest", function() { return updateOrderRequest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateOrderSuccess", function() { return updateOrderSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateOrderFailure", function() { return updateOrderFailure; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
...
const updateOrderRequest = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(`[${featureKey}] updateOrderRequest`, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrderSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(`[${featureKey}] updateOrderSuccess`, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrderFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(`[${featureKey}] updateOrderFailure`, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
let AuthEffects = class AuthEffects {
    constructor(actions$, router, auth) {
        ...
        this.LoginRequest$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["createEffect"])(() => {
            return this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_actions_auth_actions__WEBPACK_IMPORTED_MODULE_5__["loginRequest"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(action => action.payload), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])((data) => this.auth.login(data.email, data.password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(res => [Object(_actions_auth_actions__WEBPACK_IMPORTED_MODULE_5__["loginSuccess"])({ token: res.token, email: res.email }),
            ]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(Object(_actions_auth_actions__WEBPACK_IMPORTED_MODULE_5__["loginFailure"])({ error }))))));
        });
...
/* harmony import */ var _actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../actions/posts.actions */ "./src/app/store/actions/posts.actions.ts");
...
let PostsEffects = class PostsEffects {
    constructor(actions$, store, router, postService) {
        this.actions$ = actions$;
        this.store = store;
        this.router = router;
        this.postService = postService;
        this.GetPostsRequest$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => {
            return this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["getPostsRequest"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])((action) => this.postService.getPosts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(data => {
                return Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["getPostsSuccess"])({ payload: data });
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["getPostsFailure"])({ error }))))));
        });
        this.UpdateOrderRequest$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => {
            return this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["updateOrderRequest"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(action => action.posts), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])((posts) => this.postService.updateOrderPost(posts).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(data => Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["updateOrderSuccess"])({ payload: data })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["updateOrderFailure"])({ error }))))));
        });
        this.DeletePostRequest$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => {
            return this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["deletePostRequest"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(action => action.id), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])((id) => this.postService.deletePost(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(() => [Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["deletePostSuccess"])()]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(Object(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["deletePostFailure"])({ error }))))));
        });
        this.DeletePostSuccess$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => {
            return this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_8__["deletePostSuccess"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => {
...
const postReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_2__["getPostsRequest"], (state) => (Object.assign({}, state, { loading: true }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_posts_actions__WEBPACK_IMPORTED_MODULE_2__["getPostsSuccess"], (state, { payload }) => (Object.assign({}, state, { posts: payload.posts.sort((a, b) => a.order - b.order), totalPosts: payload.maxPosts, loading: false }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_auth_actions__WEBPACK_IMPORTED_MODULE_3__["logout"], () => initialState));
function reducer(state, action) {
